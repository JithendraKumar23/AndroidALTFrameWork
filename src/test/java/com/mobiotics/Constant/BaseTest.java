...
public class BaseTest implements AutomationConstant {
	...
	public void initApplication() throws Exception {
		...
		/*// Taking the App from inside the Project Flow
		...
		capabilities.setCapability("appPackage", "com.balaji.alt");
		capabilities.setCapability("appActivity", "com.altbalaji.play.MainActivity");
		capabilities.setCapability("autoGrantPermissions", "true");
		capabilities.setCapability("autoAcceptAlerts", "true");
